<script>
    ...
    async function addSchedule() {
        ...
        try {
            ...
            alert(
                "Error al asignar horario. Verifique que el usuario exista y los datos sean correctos.",
            );
        }
    }
...
<div
    class="flex flex-col lg:flex-row lg:h-[calc(100vh-100px)] gap-6 pb-10 lg:pb-0"
>
    <div
        class="w-full lg:w-1/3 h-80 lg:h-full flex flex-col rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm overflow-hidden shrink-0"
    >
        <div
            class="p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50"
        >
            <h2
        ...
        <div class="flex-1 overflow-y-auto p-2 space-y-1">
            ...
            {:else}
                {#each filteredEmployees as emp}
                    ...
                    >
                        <div
                            class="h-10 w-10 min-w-[2.5rem] rounded-full bg-gray-200 dark:bg-gray-600 flex items-center justify-center text-gray-500 dark:text-gray-300"
                        >
                            <User size={20} />
                        </div>
    ...
    <div
        id="schedule-panel"
        class="w-full lg:flex-1 h-auto lg:h-full flex flex-col rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm overflow-hidden"
    >
        {#if selectedEmployee}
            <div
                class="p-6 border-b border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row justify-between sm:items-center bg-gray-50 dark:bg-gray-800/50 gap-2"
            >
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm">
                        Para: <span
                            ...
                            >{selectedEmployee.nombre}</span
                        >
                    </p>
                </div>
                <div
                    class="text-sm text-gray-400 dark:text-gray-500 bg-white dark:bg-gray-700 px-2 py-1 rounded border border-gray-200 dark:border-gray-600 w-fit"
                >
            ...
            <div class="p-6 flex-1 lg:overflow-y-auto">
                <div
                    class="mb-8 bg-blue-50/50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-100 dark:border-blue-800"
                >
                    <h3
                        class="text-sm font-semibold text-blue-900 dark:text-blue-300 mb-3 flex items-center gap-2"
                    >
                ...
                {:else if schedules.length === 0}
                    <div
                        class="text-center py-8 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-dashed border-gray-200 dark:border-gray-600"
                    >
                        <p class="text-gray-500 dark:text-gray-400 text-sm">
                ...
                {:else}
                    <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                        {#each schedules as schedule}
                            <div
                                class="flex items-center justify-between p-4 rounded-lg border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 hover:shadow-sm transition-shadow"
                            >
                                <div class="flex items-center gap-4">
                                    <div
                                        class="h-10 w-10 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 flex items-center justify-center text-indigo-600 dark:text-indigo-400 font-bold text-xs uppercase shrink-0"
                                    >
        ...
        {:else}
            <div
                class="flex-1 flex flex-col items-center justify-center text-gray-400 dark:text-gray-500 p-8 min-h-[300px]"
            >
                <div
                    class="h-16 w-16 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center mb-4"
                >
                    <User size={32} />
                </div>
                ...
                <p class="text-sm text-center">
                    Elige un empleado de la lista superior para gestionar sus
                    horarios.
                </p>
            </div>
        {/if}
